...
| 3 | Same-season interaction `-0.6401`, 95% CI `[-1.1954, -0.0849]`; fixed season-start Elo `-0.7631`, 95% CI `[-1.4285, -0.0976]`; holdout and preceding-season estimates retain the sign but are imprecise | Advance as observational heterogeneity with qualified inferential strength; no causal or verified pre-season claim |
