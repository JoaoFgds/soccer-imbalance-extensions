...
| 3 | Points per game | `SSB × relative market value × league Gini`; league/year effects | Team-season canonical key | Cluster-robust interaction model; marginal effects, leave-one-league-out, functional form, hierarchical and alternative specifications, joint support | Advance if coverage/support pass, at least 80% of league exclusions retain the sign, at least half of temporally safe alternatives retain it, the hierarchical sign agrees, and a supported marginal effect reaches ±0.10 PPG. |
