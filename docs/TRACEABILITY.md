...
| 3 | Points per game | `SSB × relative market value × league Gini`; league/year effects | Team-season canonical key | Cluster-robust interaction model; marginal effects, leave-one-league-out, functional form, hierarchical and alternative specifications, joint support; preceding-season value sensitivity | Advance observationally if coverage/support pass, at least 80% of league exclusions retain the sign, at least half of pre-match-Elo alternatives retain it, the hierarchical sign agrees, and a supported marginal effect reaches ±0.10 PPG. Causal or pre-season language additionally requires dated valuation provenance. |
| 4 | Mean absolute SSB | Observed order versus global and phase-preserving round permutations | League-season, round, fixture, team | 10,000 seeded draws per null; empirical tail probability, Monte Carlo SE and FDR control | Advance as a benchmark if at least 250 league-seasons complete every draw under both nulls and maximum Monte Carlo SE is at most 0.0051. |
